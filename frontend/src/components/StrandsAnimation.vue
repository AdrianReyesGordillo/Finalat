...
/**
 * StrandsAnimation.vue
 * Vue 3 port of the Strands animation from ReactBits (https://reactbits.dev/animations/strands)
 * Uses OGL for WebGL shader rendering to create glowing ribbon-like strands
 * that ripple and weave across a transparent canvas.
 */
...
<template>
  <div ref="containerRef" class="strands-container" />
</template>
